...
describe('Start server', function () {
    ...
    request = supertest_1.default(server);
});
describe('GET /api/clear-cache - a simple api endpoint', function () {
    it('Clear All Cache', function () { return __awaiter(void 0, void 0, void 0, function () {
        var body;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/clear-cache')];
                case 1:
                    body = (_a.sent()).body;
